(function() {
    ...
    // Setup a connection to Algod and the Indexer via Purestake or local host
    ...
    //assetid is hard coded at the moment (https://testnet.algoexplorer.io/asset/24450735)
    let ASSETID = 24450735;
    // This is the APPID returned after creating the stateful smart contract (https://testnet.algoexplorer.io/application/24448085)
    let APPID = 24448085; //also change in contract code below
    ...
    let mn1 = "uncover judge convince pony genre siege ill race mixed like cement scissors fan organ mix ring icon embrace peanut outdoor trend menu mix about pipe";
    let openAccount = algosdk.mnemonicToSecretKey(mn1);

    //Z6S4GMC54UO4SPNX3E4KKBBYCFD7PARGAUVHL5VLQ32EQCPPJPIZAO2BM4
    let mn2 = "honey lucky split left cannon work peasant able shell easy sock valve key honey garage pipe goat toward mixed logic bike rookie develop absent charge";
    ...
    // Helper function to execute the order (3 transactions) atomic transaction
